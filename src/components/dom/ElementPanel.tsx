  ...
  return (
    <div className='absolute bottom-0 left-0 z-30 flex flex-col md:flex-row text-black'>
      <div className='bg-red-50 z-30 m-4 p-2 md:p-3 rounded-lg flex justify-start items-center gap-3'>
        <button
          className={`text-xl md:text-2xl p-1 md:p-2 rounded-xl hover:bg-red-200 ${
      ...
      <div className='flex flex-col justify-center items-start mb-4 ml-6 md:ml-0 md:mb-0 md:self-end md:py-6'>
